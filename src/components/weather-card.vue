...
<template>
  <div
    ...
    class="mt-5 text-white p-10 rounded-lg shadow-lg gap-6 mb-6 relative overflow-hidden"
  >
    <!-- Location & time -->
    ...
    <!-- forecast -->
    <div>
      <WeatherForecastDay v-for="(day, idx) in place.forecast.forecastday" :key="idx" :day="day" />
    </div>
